...
const events = [
  {
    date: today,
    title: "Approval deadline — REQ-1042",
    time: "5:00 PM",
    detail: "Office chairs (x6) awaiting your decision",
  },
  {
    date: addDays(today, 1),
    title: "Budget checkpoint with Finance",
    time: "11:00 AM",
    detail: "Mid-July spend review for Operations",
  },
  {
    date: addDays(today, 3),
    title: "Q3 budget review",
    time: "10:00 AM",
    detail: "Present department forecast to CEO",
  },
  {
    date: addDays(today, 7),
    title: "Department sync",
    time: "9:30 AM",
    detail: "Monthly requisition planning with team",
  },
  {
    date: addDays(today, 12),
    title: "Vendor evaluation",
    time: "2:00 PM",
    detail: "Sign off on office equipment shortlist",
  },
];
      ...
      <main className="flex-1 overflow-y-auto p-8 md:p-12">
        <div>
          ...
          <p className="mt-2 text-sm text-foreground/60">
            Approval deadlines, budget reviews, and department milestones.
          </p>
        </div>
