...
const items: { label: string; icon: LucideIcon; to?: LinkProps["to"] }[] = [
  ...
  { label: "Budget Requests", icon: FileText, to: "/finance/request" },
  { label: "Settings", icon: Settings, to: "/finance/settings" },
];
      ...
      <div className="border-t border-foreground/10 pt-4">
        <div className="flex items-center gap-3 px-2">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="truncate text-xs text-foreground/50">Finance Department</p>
          </div>
          <Link
            to="/login"
            aria-label="Log out"
